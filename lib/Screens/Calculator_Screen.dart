  ...
  Future<Null> _selectDOBDate(BuildContext context) async {
    ...
    if (_datePicker != null && _datePicker != _todayDateTime) {
      setState(() {
        ...
        _ageDuration =
            Age_Calculation().calculateAge(_todayDateTime, _dateOfBirth);
        _nextBirthday =
            Age_Calculation().nextBirthday(_todayDateTime, _dateOfBirth);
        _nextBirthdayWeek =
            Age_Calculation().nextBirthdayWeek(_todayDateTime, _dateOfBirth);
      });
    }
  }
                  ...
                  GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                            "${_todayDateTime.day} ${_months[_todayDateTime.month]} ${_todayDateTime.year}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
                  ...
                  GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                            "${_dateOfBirth.day} ${_months[_dateOfBirth.month]} ${_dateOfBirth.year}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
                                color: Colors.brown[900]),
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "${((_todayDateTime.difference(_dateOfBirth).inDays) / 7).floor()}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 28,
                                    color: Colors.indigo[700]),
                        ...
                        children: <Widget>[
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inDays}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 23,
                                    color: Colors.indigo[700]),
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inHours}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 23,
                                    color: Colors.indigo[700]),
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inMinutes}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 23,
                                    color: Colors.indigo[700]),
                        ...
                        children: <Widget>[
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inSeconds}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18,
                                    color: Colors.indigo[700]),
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inMilliseconds}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18,
                                    color: Colors.indigo[700]),
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "${_todayDateTime.difference(_dateOfBirth).inMicroseconds}",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18,
                                    color: Colors.indigo[700]),
